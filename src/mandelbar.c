...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/10 18:53:11 by hagoodwi          #+#    #+#             */
/*   Updated: 2020/11/10 19:21:13 by hagoodwi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

int		cycle5(double c_im, double c_re, t_all *all)
{
	int			iteration;
	t_complex	z;
...
void	mandelbar(t_all *all)
{
	...
	while (y < MAIN_WIN_HEIGHT)
	{
		...
		{
			put_pixel(all, x, y, get_colour(cycle5(max.im - y * factor.im,
