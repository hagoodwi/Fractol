...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/08 16:38:38 by hagoodwi          #+#    #+#             */
/*   Updated: 2020/11/10 19:12:22 by hagoodwi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

int		cycle2(double c_im, double c_re, t_all *all)
{
	int			iteration;
	t_complex	z;
...
void	mandelbrot(t_all *all)
{
	...
	while (y < MAIN_WIN_HEIGHT)
	{
		...
		{
			put_pixel(all, x, y, get_colour(cycle2(max.im - y * factor.im,
